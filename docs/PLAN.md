...
**Roadie is an MCP (Model Context Protocol) server** that runs on your machine as a Claude Code integration. When you integrate Roadie into Claude Code, it enables automatic intent detection, workflow dispatch, and code operations — all triggered by natural language in chat.
